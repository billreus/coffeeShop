  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        // const tHeader = ['商品ID', '商品编号', '名称', '原价', '当前价格', '是否在售', '首页主图', '宣传图片列表', '商品介绍', '详细介绍', '商品图片', '商品单位', '关键字', '类目ID', '品牌商ID']
        // const filterVal = ['id', 'goodsSn', 'name', 'originPrice', 'retailPrice', 'onSale', 'listPicUrl', 'gallery', 'brief', 'detail', 'picUrl', 'goodsUnit', 'keywords', 'categoryId', 'brandId']
        const tHeader = ['商品ID', '商品编号', '名称', '原价', '当前价格', '是否在售', '首页主图', '宣传图片列表', '商品介绍', '商品图片', '商品单位', '关键字', '类目ID', '品牌商ID']
        const filterVal = ['id', 'goodsId', 'name', 'originPrice', 'retailPrice', 'onSale', 'listPicUrl', 'gallery', 'brief', 'picUrl', 'goodsUnit', 'keywords', 'categoryId', 'brandId']
