  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="原价" prop="counterPrice">
          <el-input v-model="goods.originalPrice" placeholder="0.00">
        ...
        <el-form-item label="是否在售" prop="onSale">
          <el-radio-group v-model="goods.onSale">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="stock" width="100" label="库存数量"/>
      ...
      <el-dialog :visible.sync="productVisiable" title="设置">
        <el-form
          ref="productForm"
          :model="productForm"
          status-icon
          ...
          <el-form-item label="货品数量" prop="stock">
...
export default {
  ...
  data() {
    return {
      ...
      productForm: { id: 0, specifications: [], price: 0.00, stock: 0, url: '' },
      products: [{ id: 0, specifications: [], price: 0.00, stock: 0, url: '' }],
  ...
  methods: {
    ...
    handlePublish: function() {
      const goodsStr = this.goods
      goodsStr.gallery = JSON.stringify(this.goods.gallery)
      const finalGoods = {
        goods: goodsStr,
    ...
    specChanged: function(label) {
      if (label === false) {
        ...
        this.products = [{ id: 0, specifications: ['标准'], price: 0.00, stock: 0, url: '' }]
      } else {
        this.specifications = []
        this.products = []
      }
    ...
    specToProduct() {
      ...
      do {
        ...
        products[productsIndex] = { id: productsIndex, specifications: specifications, price: 0.00, stock: 0, url: '' }
        productsIndex++
