<template>
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="productVisiable" title="">
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { id: 0, specifications: ['标准'], price: 0.0, stock: 0, url: '' }
      ],
  ...
  methods: {
    init: function() {
      ...
      detailGoods(goodsId).then(response => {
        ...
        this.goods.gallery = JSON.parse(response.data.data.goods.gallery)
