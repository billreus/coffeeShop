    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-permission="['POST /admin/order/ship']" v-if="scope.row.orderStatus==2" type="primary" size="mini" @click="handleShip(scope.row)">发货</el-button>
          <el-button v-permission="['POST /admin/order/refund']" v-if="scope.row.orderStatus==3" type="primary" size="mini" @click="handleRefund(scope.row)">退款</el-button>
        </template>
      </el-table-column>
    </el-table>
      ...
      <el-form :data="orderDetail" label-position="left">
        ...
        <el-form-item label="商品信息">
          <el-table :data="orderDetail.orderGoods" border fit highlight-current-row>
            ...
            <el-table-column align="center" label="货品价格" prop="actualPrice" />
            <el-table-column align="center" label="货品数量" prop="goodsName" />
        ...
        <el-form-item label="费用信息">
          <span>
            ...
            (商品总价){{ orderDetail.order.orderPrice }}元 -
            (优惠减免){{ orderDetail.order.couponPrice }}元
          </span>
        </el-form-item>
        <el-form-item label="获得积分">
          <span>{{ orderDetail.order.orderIntegral }}</span>
        </el-form-item>
